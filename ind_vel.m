...
matTRANS = reshape(repmat(tcos,[len3,1]),[1,1,len2]);
matTRANS(1,2,:) = reshape(repmat(tsin,[len3,1]),[1,1,len2]);
matTRANS(2,1,:) = reshape(repmat(-tsin,[len3,1]),[1,1,len2]);
matTRANS(2,2,:) = reshape(repmat(tcos,[len3,1]),[1,1,len2]);
